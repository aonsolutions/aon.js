...
function _setCategories(agreement, callback){
	if (agreement.levels){
		...
		callback(replace, function () { _setDatas( agreement, callback ) } );
	}else{
...
function _setLevels(agreement, callback){
	if (agreement.levels){
		...
		callback(replace, function () { _setCategories( agreement, callback ) } );
	}else{
...
function _setPayments(agreement, callback){
	if(agreement.payments){
		...
		callback(replace, function () {  _setUpPaymentExtra(agreement, callback) } );
	}else{
