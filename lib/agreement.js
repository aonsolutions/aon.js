	...
	module.exports.set = function(pool, aagreement, cb) {
		...
		database.query(pool,
			...
			function(error, results, fields){
				...
				var datas = setDatas(aagreement, callback, cb);
				var agreementLevelCategory = setAgreementLevelCategory(aagreement, callback, datas);
				var agreementLevel = setAgreementLevel(aagreement, callback, agreementLevelCategory);
				var extras = setExtras(aagreement, callback, agreementLevel);
				var paymentsExtras = setPaymentsExtras(aagreement, callback, extras);
				var payments = setPayments(aagreement, callback, paymentsExtras);
				var paymentConcept = setPaymentsConcept(aagreement, callback, payments);
				var eLevelData = eraseLevelData(aagreement, callback, paymentConcept);
				var eDatas = eraseDatas(aagreement, callback, eLevelData);
				var ePayments = erasePayments(aagreement, callback, eDatas);
				var eExtras = eraseExtras(aagreement, callback, ePayments);
				var ePaymentsConcept = erasePaymentsConcept(aagreement, callback, eExtras);
				var agreementTable = setAgreement(aagreement, callback, ePaymentsConcept);
