...
*/
	...
	module.exports.set = function(pool, aagreement, cb) {
		...
		database.query(pool,
			...
			function(error, results, fields){
				...
				var agreementLevelAndCategory = setAgreementLevelAndCategory(datas);
				var extras = setExtras(agreementLevelAndCategory);
				var payments = setPayments(extras);
				var levelData = eraseLevelData(payments);
				var eDatas = eraseDatas(levelData);
	...
	var setAgreementLevelAndCategory = function(next){
		return function (pool, aagreement){
