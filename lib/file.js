...
module.exports.insertFile = function(pool, o, cb){
  if("contract" == f.module) insertFile(pool, contractAttach, o, cb);
  if("data" == f.module) insertFile(pool, dataAttach, o, cb);
  if("invoice" == f.module) insertFile(pool, invoiceAttach, o, cb);
  if("item" == f.module) insertFile(pool, itemAttach, o, cb);
  if("offer" == f.module) insertFile(pool, offerAttach, o, cb);
  if("payroll" == f.module) insertFile(pool, payrollAttach, o, cb);
  if("project" == f.module) insertFile(pool, projectAttach, o, cb);
  if("registry" == f.module) insertFile(pool, registryAttach, o, cb);
  if("sepe" == f.module) insertFile(pool, sepeAttach, o, cb);
}
