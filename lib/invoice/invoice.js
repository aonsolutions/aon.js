...
module.exports.insertInvoice = insertInvoice;
module.exports.updateInvoice = updateInvoice;
module.exports.delete = deleteInvoice;

function getInvoice(pool, filter, cb, order) {
...
function updateInvoice(pool, data, cb){
	var query = invoice
		.update(data)
...
function deleteInvoice(pool, id, cb){
	var query = invoice
		.delete()
