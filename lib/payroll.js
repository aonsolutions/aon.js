...
module.exports.salaryRecibeCRA = function(payroll, stream){
  ...
  var newEnterpriseBox = function(){
    ...
    pdf
      ...
      .fontSize(titleSize)
      .text(formatInputData(payroll.enterprise.address, 'string') + ", " + formatInputData(payroll.enterprise.locality, 'string'), x + paddingLeft4, y = y + paddingTop + 8)
      ...
      .fontSize(titleSize)
      .text(formatInputData(payroll.enterprise.cif, 'string'), x + paddingLeft4 + 10, y = y + paddingTop + 8)
      .text(formatInputData(payroll.enterprise.ccc, 'number'), x + paddingLeft4 + 145, y)
  ...
  var newEmployeeBox = function(){
    ...
    pdf
      ...
      .fontSize(titleSize)
      .text(formatInputData(payroll.employee.nif, 'string'), leftEmployeeX + paddingLeft4 + 10, y = y + paddingTop + 3)
      .text(formatInputData(payroll.employee.ss, 'number'), leftEmployeeX + paddingLeft4 + 155, y)
      .moveTo(leftEmployeeX - left, y = y + paddingTop + 8).lineTo(maxRightWidth, y).stroke()
      ...
      .text(formatInputData(payroll.employee.professional_group, 'string'), leftEmployeeX + paddingLeft4 + 90, y)
      .text(formatInputData(payroll.employee.seniority_date, 'string'), leftEmployeeX + paddingLeft4 + 210, y)
      .moveTo(leftEmployeeX - left, y = y + paddingTop + 8).lineTo(maxRightWidth, y).stroke()
  ...
  var newSettlementBox = function(){
    ...
    pdf
      ...
      .fontSize(titleSize)
      .text(formatInputData(payroll.settlement.start_date, 'string') +'  -  '+ formatInputData(payroll.settlement.end_date, 'string'), leftEmployeeX + paddingLeft4 + 10, y = y + paddingTop + 8)
      .text(formatInputData(payroll.settlement.total_days, 'number'), leftEmployeeX + paddingLeft4 + 220, y)
      .moveTo(leftEmployeeX - left, y = y + paddingTop + 8).lineTo(maxRightWidth, y).stroke()
    ...
    for(i = 0; i < payroll.deductions.length; i++){
      ...
      if(deduction.value != 0){
        ...
        pdf
          ...
          .text(formatAmount(total) , quarterColumn + numberOffset(formatAmount(total)) , y);
        y = y + 10;
      }
    }
  }
