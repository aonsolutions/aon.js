...
module.exports.newStandardPayroll = function(payroll, stream){
    ...
    pdf
      ...
      if(taxesS.value == 0){
        ...
        pdf
          ...
          .text(formatAmount(111.48), originalX + left + 497 +  numberOffset(formatAmount(111.48)), originalY + footer + top + 165)
  ...
  var newAccrual = function(){
    ...
    for(i = 0; i < payroll.accruals.length; i++){
      ...
      for(j = 0; j < accrual.types.length; j++){
        ...
        pdf
          .font(textFont)
          .text(formatAmount(type.type_value) + " €" , firstColumn + numberOffset(formatAmount(type.type_value)) , y)
      ...
      y = y + 2;
      pdf
        .text(formatAmount(craTotal) , quarterColumn + numberOffset(formatAmount(craTotal)) , craY)
    ...
    pdf
      ...
      .text(formatAmount(payroll.total_accrual) , accrualX + paddingLeftTotal + numberOffset(formatAmount(payroll.total_accrual)), accrualY)
  ...
  var newDeductionFirstPage = function(){
    ...
    if(deductionOY <= 348){
      ...
      pdf
        ...
        .font(textFont)
        .text(formatAmount(payroll.total_contributions), quarterColumn + numberOffset(formatAmount(payroll.total_contributions)), deductionY)
        .moveTo(50, deductionY + 10).lineTo(quarterColumn + 45,  deductionY + 10).stroke();

      pdf
        .font(textFont)
        .text(formatAmount(common_contingency.value) + " €", firstColumn + numberOffset(formatAmount(common_contingency.value)), y = y + 15)
        .text("  por Contigencias comunes", secondColumn, y)
        .text(formatAmount(common_contingency.percent) + " %", thirdColumn + numberOffset(formatAmount(common_contingency.percent)), y)
        .text(formatAmount(unemployment.value) + " €", firstColumn + numberOffset(formatAmount(unemployment.value)), y = y + 10)
        .text("  por Desempleo", secondColumn, y)
        .text(formatAmount(unemployment.percent) + " %", thirdColumn + numberOffset(formatAmount(unemployment.percent)), y)
        .text(formatAmount(professional_formation.value) + " €", firstColumn + numberOffset(formatAmount(professional_formation.value)), y = y + 10)
        .text("  por Fromación profesional", secondColumn, y)
        .text(formatAmount(professional_formation.percent) + " %", thirdColumn + numberOffset(formatAmount(professional_formation.percent)), y)
        .text("  por Horas extraordinarias (Estruc.)", secondColumn, y = y + 10)
        .text(formatAmount(extra_hours_e.value) + " €", firstColumn + numberOffset(formatAmount(extra_hours_e.value)), y)
        .text("  por Horas extraordinarias (No Estruc.)", secondColumn, y = y + 10)
        .text(formatAmount(extra_hours_ne.value) + " €", firstColumn + numberOffset(formatAmount(extra_hours_ne.value)), y);
      ...
      pdf
        ...
        .font(textFont)
        .text(formatAmount(taxes), quarterColumn + numberOffset(formatAmount(taxes)), y)
        .moveTo(tittle, y = y + 10).lineTo(quarterColumn + 45,  y).stroke()
        .text("  por Retribuciones dinerarias", secondColumn, y = y + 5)
        .text(formatAmount(taxesD.value) + " €", firstColumn + numberOffset(formatAmount(taxesD.value)), y)
        .text(formatAmount(taxesD.percent) + " %", thirdColumn + numberOffset(formatAmount(professional_formation.percent)), y)
        .text("  por Retribuciones en especie", secondColumn, y = y + 10)
        .text(formatAmount(taxesS.value) + " €", firstColumn + numberOffset(formatAmount(taxesS.value)), y)
        .text(formatAmount(taxesD.percent) + " %", thirdColumn + numberOffset(formatAmount(professional_formation.percent)), y);
      ...
      pdf
        ...
        .font(textFont)
        .text(formatAmount(advancesTOTAL), quarterColumn + numberOffset(formatAmount(advancesTOTAL)), y)
      ...
      pdf
        ...
        .font(textFont)
        .text(formatAmount(spicesTOTAL), quarterColumn + numberOffset(formatAmount(spicesTOTAL)), y)
        .moveTo(tittle, y + 10).lineTo(quarterColumn + 45,  y + 10).stroke();
      ...
      for(var i = 0; i < other_deductions.types.length; i++){
        ...
        pdf
          ...
          .text(formatAmount(type.value) + " €", firstColumn + numberOffset(formatAmount(type.value)), y);
      }

      pdf
        .font(textFont)
        .text(formatAmount(other_deductionsTOTAL), quarterColumn + numberOffset(formatAmount(other_deductionsTOTAL)), other_deductionsY)
      ...
      pdf
        ...
        .text(formatAmount(payroll.total_deductions) , deductionX + paddingLeftTotal + numberOffset(formatAmount(payroll.total_deductions)), y)
        .moveTo(deductionX + 150 , y = y + 10).lineTo(deductionX + 545 , y).stroke();

      pdf
        .text('LÍQUIDO TOTAL A PERCIBIR (A-B)' , deductionX + 160, y = y + 10)
        .text(formatAmount(payroll.liquid_perceive) , deductionX + paddingLeftTotal + numberOffset(formatAmount(payroll.liquid_perceive)), y)
  ...
  var newDeductionSecondPage = function(){
    if(deductionOY > 348){
      ...
      pdf
        .moveTo(x, deductionY - 10).lineTo(accrualWidth, deductionY - 10).stroke();
      ...
      pdf
        ...
        .text(formatAmount(payroll.total_accrual) , deductionX + paddingLeftTotal + numberOffset(formatAmount(payroll.total_accrual)), y)
...
module.exports.standardPayroll = function(payroll, stream){
  ...
  var newAccrual = function(){
      ...
      for(var j = 0; j < payroll.accruals[i].types.length; j++){
        if(salary_perceptions_codes.includes(payroll.accruals[i].types[j].code)){
          ...
          pdf
            ...
            .text(formatAmount(type.type_value) , accrualX + paddingLeftValue + numberOffset(formatAmount(type.type_value)) , accrualY)
            .lineWidth(0.1)
    ...
    if(extra_hours_total == 0){
      ...
      pdf
        .text(formatAmount(extra_hours_total) , accrualX + paddingLeftValue + numberOffset(formatAmount(extra_hours_total)), accrualY)
        .moveTo(accrualX + paddingLeft2, accrualY + paddingTopLine).lineTo(accrualX + 376, accrualY + paddingTopLine).stroke();
    }
    ...
    if(extra_perks_total == 0){
      ...
      pdf
        .text(formatAmount(extra_perks_total) , accrualX + paddingLeftValue + numberOffset(formatAmount(extra_perks_total)), accrualY)
        .moveTo(accrualX + paddingLeft2, accrualY + paddingTopLine).lineTo(accrualX + 376, accrualY + paddingTopLine).stroke();
    }
    ...
    if(spices_salary_total == 0){
      ...
      pdf
        .text(formatAmount(spices_salary_total) , accrualX + paddingLeftValue + numberOffset(formatAmount(spices_salary_total)), accrualY)
        .moveTo(accrualX + paddingLeft2, accrualY + paddingTopLine).lineTo(accrualX + 376, accrualY + paddingTopLine).stroke();
    }
    ...
    if(suplies == undefined){
      ...
      for(i = 0; i < suplies.types.length; i++){
        ...
        pdf
          ...
          .text(formatAmount(suply.type_value) , accrualX + paddingLeftValue + numberOffset(formatAmount(suply.type_value)), accrualY)
    ...
    if(compensations_SS == undefined){
      ...
      for(i = 0; i < compensations_SS.types.length; i++){
        ...
        pdf
          ...
          .text(formatAmount(compensation.type_value) , accrualX + paddingLeftValue + numberOffset(formatAmount(compensation.type_value)), accrualY)
          .moveTo(accrualX + paddingLeft3, accrualY + paddingTopLine).lineTo(accrualX + 376, accrualY + paddingTopLine).stroke();
      }
    }
    ...
    if(other_perceptions == undefined){
      ...
      for(i = 0; i < other_perceptions.types.length; i++){
        ...
        pdf
          ...
          .text(formatAmount(perception.type_value) , accrualX + paddingLeftValue + numberOffset(formatAmount(perception.type_value)), accrualY)
          .moveTo(accrualX + paddingLeft3, accrualY + paddingTopLine).lineTo(accrualX + 376, accrualY + paddingTopLine).stroke();
      }
    }
  ...
  var newDeductionFirstPage = function(){
    ...
    if(deductionOY <= 353.304){
      ...
      pdf
        ...
        .text(formatPercent(common_contingency.percent) + ' %' , accrualX + paddingLeftPercent + numberOffset(formatPercent(common_contingency.percent)), deductionY)
        .text(formatAmount(common_contingency.value), accrualX + paddingLeftValue + numberOffset(formatAmount(common_contingency.value)), deductionY)
        ...
        .text(formatPercent(unemployment.percent) + ' %' , accrualX + paddingLeftPercent + numberOffset(formatPercent(unemployment.percent)), deductionY)
        .text(formatAmount(unemployment.value), accrualX + paddingLeftValue + numberOffset(formatAmount(unemployment.value)), deductionY)
        .moveTo(deductionX + paddingLeft2, deductionY + paddingTopLine).lineTo(deductionX + 376, deductionY + paddingTopLine).stroke()

        .text('Formación profsional' , deductionX + paddingLeft2, deductionY = deductionY + paddingTopTL)
        .text(formatPercent(professional_formation.percent) + ' %' , accrualX + paddingLeftPercent + numberOffset(formatPercent(professional_formation.percent)), deductionY)
        .text(formatAmount(professional_formation.value), accrualX + paddingLeftValue + numberOffset(formatAmount(professional_formation.value)), deductionY)
        .moveTo(deductionX + paddingLeft2, deductionY + paddingTopLine).lineTo(deductionX + 376, deductionY + paddingTopLine).stroke()
        ...
        .text(formatPercent(extra_hours_e.percent) + ' %' , accrualX + paddingLeftPercent + numberOffset(formatPercent(extra_hours_e.percent)), deductionY)
        .text(formatAmount(extra_hours_e.value), accrualX + paddingLeftValue + numberOffset(formatAmount(extra_hours_e.value)), deductionY)
        ...
        .text(formatPercent(extra_hours_ne.percent) + ' %' , accrualX + paddingLeftPercent + numberOffset(formatPercent(extra_hours_ne.percent)), deductionY)
        .text(formatAmount(extra_hours_ne.value), accrualX + paddingLeftValue + numberOffset(formatAmount(extra_hours_ne.value)), deductionY)
        .moveTo(deductionX + paddingLeft3, deductionY + paddingTopLine).lineTo(deductionX + 376, deductionY + paddingTopLine).stroke()

        .text('TOTAL APORTACIONES' , deductionX + paddingLeft2, deductionY = deductionY + paddingTopTL)
        .text(formatAmount(payroll.total_contributions), accrualX + paddingLeftValue + numberOffset(formatAmount(payroll.total_contributions)), deductionY)
        .moveTo(deductionX + paddingLeft2, deductionY + paddingTopLine).lineTo(deductionX + 376, deductionY + paddingTopLine).stroke()

        .text('2. Impuestos sobre la renta de personas físicas' , deductionX + paddingLeft1, deductionY = deductionY + paddingTopTL)
        .text(formatPercent(taxes.percent) + ' %' , accrualX + paddingLeftPercent + numberOffset(formatPercent(taxes.percent)), deductionY)
        .text(formatAmount(taxes.value), accrualX + paddingLeftValue + numberOffset(formatAmount(taxes.value)), deductionY)
        ...
        .text(formatAmount(advances.value), accrualX + paddingLeftValue + numberOffset(formatAmount(advances.value)), deductionY)
        .moveTo(deductionX + paddingLeft1, deductionY + paddingTopLine).lineTo(deductionX + 376, deductionY + paddingTopLine).stroke()

        .text('4. Valor de los productos recibidos en especie' , deductionX + paddingLeft1, deductionY = deductionY + paddingTopTL)
        .text(formatAmount(spices.value), accrualX + paddingLeftValue + numberOffset(formatAmount(spices.value)), deductionY)
        .moveTo(deductionX + paddingLeft1, deductionY + paddingTopLine).lineTo(deductionX + 376, deductionY + paddingTopLine).stroke()

        .text('5. Otras deducciones' ,  deductionX + paddingLeft1, deductionY = deductionY + paddingTopTL)
        .text(formatAmount(other_deductions.value), accrualX + paddingLeftValue + numberOffset(formatAmount(other_deductions.value)), deductionY)
        .moveTo(deductionX + paddingLeft1, deductionY + paddingTopLine).lineTo(deductionX + 376, deductionY + paddingTopLine).stroke()
        ...
        .font(textFont)
        .text(formatAmount(payroll.total_deductions) , deductionX + paddingLeftTotal + numberOffset(formatAmount(payroll.total_deductions)), deductionY)
  ...
  var newDeductionSecondPage = function(){
    if(deductionOY > 353.304){
      ...
      common_contingency = getDeduction("Contigencias comunes");
      unemployment = getDeduction("Desempleo");
      professional_formation = getDeduction("Formación profesional");
      extra_hours_e = getDeduction("Fuerza mayor o estructurales (HE)");
      extra_hours_ne = getDeduction("No estructurales (HE)");
      ...
      pdf
        ...
        .text('Contigencias comunes' , deductionX + paddingLeft2, deductionY = deductionY + paddingTopTT)
        .text(formatAmount(common_contingency.percent) + ' %' , accrualX + paddingLeftPercent + numberOffset(formatAmount(common_contingency.percent)), deductionY)
        .text(formatAmount(common_contingency.value), accrualX + paddingLeftValue + numberOffset(formatAmount(common_contingency.value)), deductionY)
        .lineWidth(0.1)
        .moveTo(deductionX + paddingLeft2, deductionY + paddingTopLine).lineTo(deductionX + 376, deductionY + paddingTopLine).stroke()

        .text('Desempleos' , deductionX + paddingLeft2, deductionY = deductionY + paddingTopTL)
        .text(formatAmount(unemployment.percent) + ' %' , accrualX + paddingLeftPercent + numberOffset(formatAmount(unemployment.percent)), deductionY)
        .text(formatAmount(unemployment.value), accrualX + paddingLeftValue + numberOffset(formatAmount(unemployment.value)), deductionY)
        .moveTo(deductionX + paddingLeft2, deductionY + paddingTopLine).lineTo(deductionX + 376, deductionY + paddingTopLine).stroke()

        .text('Formación profsional' , deductionX + paddingLeft2, deductionY = deductionY + paddingTopTL)
        .text(formatAmount(professional_formation.percent) + ' %' , accrualX + paddingLeftPercent + numberOffset(formatAmount(professional_formation.percent)), deductionY)
        .text(formatAmount(professional_formation.value), accrualX + paddingLeftValue + numberOffset(formatAmount(professional_formation.value)), deductionY)
        .moveTo(deductionX + paddingLeft2, deductionY + paddingTopLine).lineTo(deductionX + 376, deductionY + paddingTopLine).stroke()

        .text('Horas extraordinarias' , deductionX + paddingLeft2, deductionY = deductionY + paddingTopTL)
        .text('Fuerza mayor o estructurales' , deductionX + paddingLeft3, deductionY = deductionY + paddingTopTT)
        .text(formatAmount(extra_hours_e.percent) + ' %' , accrualX + paddingLeftPercent + numberOffset(formatAmount(extra_hours_e.percent)), deductionY)
        .text(formatAmount(extra_hours_e.value), accrualX + paddingLeftValue + numberOffset(formatAmount(extra_hours_e.value)), deductionY)
        .moveTo(deductionX + paddingLeft3, deductionY + paddingTopLine).lineTo(deductionX + 376, deductionY + paddingTopLine).stroke()

        .text('No estructurales' , deductionX + paddingLeft3, deductionY = deductionY + paddingTopTL)
        .text(formatAmount(extra_hours_ne.percent) + ' %' , accrualX + paddingLeftPercent + numberOffset(formatAmount(extra_hours_ne.percent)), deductionY)
        .text(formatAmount(extra_hours_ne.value), accrualX + paddingLeftValue + numberOffset(formatAmount(extra_hours_ne.value)), deductionY)
        .moveTo(deductionX + paddingLeft3, deductionY + paddingTopLine).lineTo(deductionX + 376, deductionY + paddingTopLine).stroke()
        ...
        .text('2. Impuestos sobre la renta de personas físicas' , deductionX + paddingLeft1, deductionY = deductionY + paddingTopTL)
        .text(formatAmount(taxes.percent) + ' %' , accrualX + paddingLeftPercent + numberOffset(formatAmount(taxes.percent)), deductionY)
        .text(formatAmount(taxes.value), accrualX + paddingLeftValue + numberOffset(formatAmount(taxes.value)), deductionY)
        .moveTo(deductionX + paddingLeft1, deductionY + paddingTopLine).lineTo(deductionX + 376, deductionY + paddingTopLine).stroke()
...
module.exports.salaryRecibeCRA = function(payroll, stream){
  ...
  var newHearderTittle = function(){
    ...
    paddingLeft2 = 16;  //Padding-left second text
    paddingLeft3 = 20;  //Padding-left third text
    paddingLeft4 = 24;  //Padding-left forth text
    marginTL = 2;       //Margin bettwen text / line, line / text, line / line

    if(payroll.logo != undefined){
      pdf
        .image(payroll.signature_logo, x+95, 0, {scale: 0.06})
        .font(titleFont)
    		.fontSize(headingSize)
        .text('RECIBO DE SALARIO', x+370, 0)
        .moveDown(1);
    }else{
      //Start drawing PDF
      pdf
    	  .font(titleFont)
    		.fontSize(headingSize)
    		.text('RECIBO DE SALARIO', x+80, 10)
    		.moveDown(1);
    }
  }
  ...
  var newEnterpriseBox = function(){
    ...
    pdf
      ...
      .font(headingFont)
      .fontSize(titleSize)
      .text(payroll.enterprise.name, x + centerBoxText, y = y + paddingTop)
      ...
      .fontSize(titleSize)
      .text(payroll.enterprise.address + ", " + payroll.enterprise.locality, x + paddingLeft4, y = y + paddingTop + 8)
      ...
      .fontSize(titleSize)
      .text(payroll.enterprise.cif, x + paddingLeft4 + 10, y = y + paddingTop + 8)
      .text(payroll.enterprise.ccc, x + paddingLeft4 + 145, y)
  ...
  var newEmployeeBox = function(){
    ...
    // -----------------------------------------------------------------------------------------------------------------
    leftEmployeeX = ox + width + left + 5 ;   //Position X for left line employee box
    employeeY = 15;                           //Start y for employee box
    employeeTop = 12;                         //Padding-top bettwen text
    centerBoxText = 80;

    pdf
      .moveTo(leftEmployeeX - left, 10).lineTo(maxRightWidth, 10).stroke()   //Horizontal top line
      ...
      .font(headingFont)
      .fontSize(titleSize)
      .text(payroll.employee.fullname, leftEmployeeX + centerBoxText, y = y + paddingTop)
      ...
      .fontSize(titleSize)
      .text(payroll.employee.nif, leftEmployeeX + paddingLeft4 + 10, y = y + paddingTop + 3)
      .text(payroll.employee.ss, leftEmployeeX + paddingLeft4 + 155, y)
      .moveTo(leftEmployeeX - left, y = y + paddingTop + 8).lineTo(maxRightWidth, y).stroke()
      ...
      .fontSize(titleSize)
      .text(payroll.employee.quote_group, leftEmployeeX + paddingLeft2, y = y + paddingTop + 5)
      .text(payroll.employee.professional_group, leftEmployeeX + paddingLeft4 + 90, y)
      .text(payroll.employee.seniority_date, leftEmployeeX + paddingLeft4 + 210, y)
      .moveTo(leftEmployeeX - left, y = y + paddingTop + 8).lineTo(maxRightWidth, y).stroke()
      ...
      .moveTo(leftEmployeeX - left, 10).lineTo(leftEmployeeX - left, y).stroke()              //Vertical left line
      .moveTo(maxRightWidth, 10).lineTo(maxRightWidth, y).stroke()                            //Vertical right line
      .moveDown(1);
  }
  ...
  var newSettlementBox = function(){
    ...
    pdf
      ...
      .fontSize(titleSize)
      .text(payroll.settlement.start_date +'  -  '+ payroll.settlement.end_date, leftEmployeeX + paddingLeft4 + 10, y = y + paddingTop + 8)
      .text(payroll.settlement.total_days, leftEmployeeX + paddingLeft4 + 220, y)
      .moveTo(leftEmployeeX - left, y = y + paddingTop + 8).lineTo(maxRightWidth, y).stroke()
  ...
  var newFooterBox = function(){
    ...
    pdf
      ...
      .text('AP. EMPRESA' , originalX + 120 , y = originalY + footer + top + 12)
      .text('DESGLOSE' , originalX + 230 , y = originalY + footer + top + 12)
      .text('TOTALES' , originalX + 455 , y = originalY + footer + top + 12)
      ...
      .text(formatAmount(payroll.footer_ss_quotation.common_contingency.base), originalX + 35 + numberOffset(formatAmount(payroll.footer_ss_quotation.common_contingency.base)) , y = y + 10)
      .text(formatAmount(payroll.footer_ss_quotation.common_contingency.monthly_remuneration), originalX + 223 + numberOffset(formatAmount(payroll.footer_ss_quotation.common_contingency.monthly_remuneration)) , y)
      .text(formatAmount(payroll.total_accrual), originalX + 425 + numberOffset(formatAmount(payroll.total_accrual)) , y)
      .text(formatAmount(payroll.total_deductions), originalX + 510 + numberOffset(formatAmount(payroll.total_deductions)) , y)

      .text(formatAmount(payroll.footer_ss_quotation.common_contingency.type_percent) + " %", originalX + 95 + numberOffset(formatAmount(payroll.footer_ss_quotation.common_contingency.type_percent)) , y = y + 8)
      .text("|", originalX + 150, y)
      .text(formatAmount(payroll.footer_ss_quotation.common_contingency.company_input), originalX + 135 + numberOffset(formatAmount(payroll.footer_ss_quotation.common_contingency.company_input)) , y)
      ...
      .text(formatAmount(payroll.footer_ss_quotation.common_contingency.extraordinary_pay_packet), originalX + 223 + numberOffset(formatAmount(payroll.footer_ss_quotation.common_contingency.extraordinary_pay_packet)) , y = y + 10)
      .text(formatAmount(payroll.liquid_perceive), originalX + 510 + numberOffset(formatAmount(payroll.liquid_perceive)) , y)
      ...
      .text(formatAmount(payroll.footer_ss_quotation.professional_contingency.base), originalX + 35 + numberOffset(formatAmount(payroll.footer_ss_quotation.professional_contingency.base)) , y = y + 10)
      .text(formatAmount(payroll.footer_ss_quotation.professional_contingency.type_percent_at) + " %", originalX + 95 + numberOffset(formatAmount(payroll.footer_ss_quotation.professional_contingency.type_percent_at)) , y)
      .text("|", originalX + 150, y)
      .text(formatAmount(payroll.footer_ss_quotation.professional_contingency.company_input_at), originalX + 135 + numberOffset(formatAmount(payroll.footer_ss_quotation.professional_contingency.company_input_at)) , y)
      .moveTo(originalX + 105 , y = y + 10).lineTo(originalX + 200 , y).stroke()

      .text('Desempleo' , originalX + 110, y = y + 3)
      .text(formatAmount(payroll.footer_ss_quotation.professional_contingency.type_percent_unemployment) + " %", originalX + 95 + numberOffset(formatAmount(payroll.footer_ss_quotation.professional_contingency.type_percent_unemployment)) , y = y + 10)
      .text("|", originalX + 150, y)
      .text(formatAmount(payroll.footer_ss_quotation.professional_contingency.company_input_unemployment), originalX + 135 + numberOffset(formatAmount(payroll.footer_ss_quotation.professional_contingency.company_input_unemployment)) , y)
      .moveTo(originalX + 105 , y = y + 10).lineTo(originalX + 200 , y).stroke()

      .text('Formación profesional' , originalX + 110, y = y + 3)
      .text(formatAmount(payroll.footer_ss_quotation.professional_contingency.type_percent_professional_formation) + " %", originalX + 95 + numberOffset(formatAmount(payroll.footer_ss_quotation.professional_contingency.type_percent_professional_formation)) , y = y + 10)
      .text("|", originalX + 150, y)
      .text(formatAmount(payroll.footer_ss_quotation.professional_contingency.company_input_professional_formation), originalX + 135 + numberOffset(formatAmount(payroll.footer_ss_quotation.professional_contingency.company_input_professional_formation)) , y)
      .moveTo(originalX + 105 , y = y + 10).lineTo(originalX + 200 , y).stroke()

      .text('FOGASA' , originalX + 110, y = y + 3)
      .text(formatAmount(payroll.footer_ss_quotation.professional_contingency.type_percent_salary_warranty) + " %", originalX + 95 + numberOffset(formatAmount(payroll.footer_ss_quotation.professional_contingency.type_percent_salary_warranty)) , y = y + 10)
      .text("|", originalX + 150, y)
      .text(formatAmount(payroll.footer_ss_quotation.professional_contingency.company_input_salary_warranty), originalX + 135 + numberOffset(formatAmount(payroll.footer_ss_quotation.professional_contingency.company_input_salary_warranty)) , y)

      .moveTo(originalX + 10 , y = y + 10).lineTo(originalX + 305 , y).stroke()
      .text('3. Horas Extras' , originalX + 15, y = y + 3)
      .text('No Estructurales' , originalX + 110, y)
      .text('Base HE (NE)' , originalX + 210, y)
      .text(formatAmount(payroll.footer_ss_quotation.aditional_quotation.company_input_overwhelming_force), originalX + 95 + numberOffset(formatAmount(payroll.footer_ss_quotation.aditional_quotation.company_input_overwhelming_force)) , y = y + 10)
      .text(formatAmount(payroll.footer_ss_quotation.aditional_quotation.base_overwhelming_force), originalX + 223 + numberOffset(formatAmount(payroll.footer_ss_quotation.aditional_quotation.base_overwhelming_force)) , y)
      ...
      .text(formatAmount(payroll.footer_ss_quotation.aditional_quotation.company_input_non_structural), originalX + 95 + numberOffset(formatAmount(payroll.footer_ss_quotation.aditional_quotation.company_input_non_structural)) , y = y + 10)
      .text(formatAmount(payroll.footer_ss_quotation.aditional_quotation.base_non_structural), originalX + 223 + numberOffset(formatAmount(payroll.footer_ss_quotation.aditional_quotation.base_non_structural)) , y)

      .moveTo(originalX + 10 , y = y + 10).lineTo(originalX + 305 , y).stroke()
      .text('4. IRPF' , originalX + 15, y = y + 3)
      .text(formatAmount(payroll.footer_ss_quotation.base_irpf), originalX + 35 + numberOffset(formatAmount(payroll.footer_ss_quotation.base_irpf)) , y = y + 10)
  ...
  var newAccrual = function(){
    ...
    pdf
      ...
      .moveTo(x, y).lineTo(x, originalY + 715).stroke()
      .moveTo(accrualWidth, y).lineTo(accrualWidth, originalY + 715).stroke()

      .moveTo(x + 10, y = y + 10).lineTo(x + 558, y).stroke()
      .moveTo(x + 10, y).lineTo(x + 10, y + 420).stroke()
      .moveTo(x + 558, y).lineTo(x + 558, y + 420).stroke()
      .moveTo(x + 10, y + 420).lineTo(x + 558, y + 420).stroke();

    pdf
      .font(textFont)
      .text('CUANTÍA' , originalX + 40 , y = 137)
      ...
      .moveTo(x + 110, y - 5).lineTo(x + 110, y + 416).stroke()
      .moveTo(x + 390, y - 5).lineTo(x + 390, y + 416).stroke()
      .moveTo(x + 472, y - 5).lineTo(x + 472, y + 416).stroke();
    ...
    for(i = 0; i < payroll.accruals.length; i++){
      ...
      for(j = 0; j < accrual.types.length; j++){
        ...
        pdf
          ...
          .text(formatAmount(type.type_value) , thirdColumn + numberOffset(formatAmount(type.type_value)) , y);
        y = y + 10;
      }
    }
  }
  ...
  var newDeduction = function(){
    ...
    for(i = 0; i < payroll.deductions.length; i++){
      ...
      if(deduction.value != 0){
        pdf
          .font(textFont)
          .text(formatAmount(deduction.percent) + " %" , firstColumn + numberOffset(formatAmount(deduction.percent)), y)
          .text(deduction.name , secondColumn + 8 , y)
          .text(formatAmount(deduction.value) , quarterColumn + numberOffset(formatAmount(deduction.value)) , y);
        y = y + 10;
      }
    }
  }
